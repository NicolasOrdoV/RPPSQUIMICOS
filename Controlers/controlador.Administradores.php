...
class ControladorAdministradores
{
    ...
    try {
        ...
        if (preg_match('/^[0-9]+$/', $_POST["registrarIdentificacionAd"]) &&
            preg_match('/^[a-zA-ZáéíóúÁÉÍÓÚÑ ]+$/', $_POST["registrarNombreAd"]) &&
                             ...
                             <tr style="border-collapse:collapse">
                              <td align="center" valign="top" style="Margin:0;width:540px">
                               <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                 <tr style="border-collapse:collapse">
                                  <td align="left" style="Margin:0;padding-bottom:10px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:15px;font-family:"open sans", "helvetica neue", helvetica, arial, sans-serif;line-height:30px;color:#000000">¡Hola '.$data["registrarCorreoAd"].'!<span style="font-family:roboto, "helvetica neue", helvetica, arial, sans-serif"></span></p></td>
                                 </tr>
                                 <tr style="border-collapse:collapse">
                                  <td align="left" style="Margin:0;padding-bottom:10px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:15px;font-family:"open sans", "helvetica neue", helvetica, arial, sans-serif;line-height:30px;color:#000000">BIENVENIDO a la familia de RPPSQUIMICOS, ahora tendras un usuario con el cual acceder:
                                    <p>Correo electronico: '.$data["registrarCorreoAd"]. '</p>
                                    <p>Contraseña: '.$data["registrarContraseñaAd"].'</p>
                                    <p>Te recomendamos que cambies tu contraseña para que no tengas problemas al memorizarla.</p>!&nbsp;<span style="font-family:roboto, "helvetica neue", helvetica, arial, sans-serif"></span></p><br>
                                      <a href="http://localhost/RPPSQUIMICOS.COM/index.php?paginasUsuario=InicioSesion">Ir a inicio de sesión<a>
                                    </td>
                                 </tr>
                               </table></td>
                             </tr>
