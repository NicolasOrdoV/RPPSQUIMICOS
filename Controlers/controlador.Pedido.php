...
';
  ...
  static public function enviarCorreoPedidoAdminNotifica($client, $adm){
    foreach ($client as $deta) {
      $dataCli=[
      'nombre'=>$deta['nombreEC'],
      'correo'=> $deta['correocontEC'],
    ...
    try {
        ...
        //Recipients
        $mail->setFrom('rppsquimicos@gmail.com');
        $mail->addAddress($dataAdm['correo']);     // Add a recipient
                         ...
                         <tr style="border-collapse:collapse">
                          <td align="center" valign="top" style="Margin:0;width:700px">
                           <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-size:100%" role="presentation">
                             ...
                             <tr style="border-collapse:collapse">
                              <td align="center" class="es-m-p30b amp-banner" style="Margin:0;font-size:0px"><a target="_blank" href="https://:v" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:"open sans", "helvetica neue", helvetica, arial, sans-serif;font-size:15px;text-decoration:underline;color:#000001"><img src="http://imgfz.com/i/zaIiNLY.png" alt="Pedido Completo" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic" width="374" sizes="(max-width:600px) 80vw, 373px" class="adapt-img" title="Pedido Completo"></a></td>
                             </tr>
                           </table></td>
                         </tr>
                       </table></td>
                       ...
                       <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                         <tr style="border-collapse:collapse">
                          <td align="center" valign="top" style="Margin:0;width:540px">
                           <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                             <tr style="border-collapse:collapse">
                              <td align="left" style="Margin:0;padding-bottom:10px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:15px;font-family:"open sans", "helvetica neue", helvetica, arial, sans-serif;line-height:30px;color:#000000">¡Hola '. $dataAdm['nombre'] .'!<span style="font-family:roboto, "helvetica neue", helvetica, arial, sans-serif"></span></p></td>
                             </tr>
                             <tr style="border-collapse:collapse">
                              <td align="left" style="Margin:0;padding-bottom:10px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:15px;font-family:"open sans", "helvetica neue", helvetica, arial, sans-serif;line-height:30px;color:#000000">'. $dataCli['nombre'] .' ('.$dataCli['correo'].') Acaba de hacer un pedido. ¡Apresurate a preparar el pedido! !&nbsp;<span style="font-family:roboto, "helvetica neue", helvetica, arial, sans-serif"></span></p></td>
                             </tr>
                           </table></td>
                         </tr>
                       </table></td>
                       ...
                       <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                         ...
                         <tr class="es-visible-simple-html-only" style="border-collapse:collapse">
                          <td align="center" valign="top" style="Margin:0;width:700px">
                           <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;background-position:center top;background-color:#515151;border-radius:0 0 30px 30px" bgcolor="#515151" role="presentation">
                             <tr style="border-collapse:collapse">
                              <td align="center" style="Margin:0;padding-top:20px"><h1 style="Margin:0;line-height:43px;mso-line-height-rule:exactly;font-family:"open sans", "helvetica neue", helvetica, arial, sans-serif;font-size:36px;font-style:normal;font-weight:bold;color:#FFFFFF">¿Necesitas los detalles?</h1></td>
                             </tr>
                             <tr style="border-collapse:collapse">
                              <td align="center" style="Margin:0;padding-top:30px;padding-right:140px;padding-left:140px" class="es-m-p20l es-m-p20r"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:"open sans", "helvetica neue", helvetica, arial, sans-serif;line-height:32px;color:#FFFFFF;letter-spacing:1px"> En el siguiente apartado podrás ver todos los detalles&nbsp; que necesitas para proceder</p></td>
                             </tr>
                             <tr style="border-collapse:collapse">
                              <td align="center" style="Margin:0;padding-left:20px;padding-right:20px;padding-bottom:50px;font-size:0px"><a target="_blank" href="https://:v" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:"open sans", "helvetica neue", helvetica, arial, sans-serif;font-size:15px;text-decoration:underline;color:#000001"><img class="adapt-img" src="http://imgfz.com/i/yQpnGa3.png" alt="¡Ver Detalle!" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic" width="382" title="Visita nuestros productos"></a></td>
                             </tr>
                           </table></td>
                         </tr>
                       </table></td>
