...
class ControladorInventario
{
    ...
    static public function ctrSendNotifyCuantity($user,$producs_pe){
        ...
        try {
            ...
            $mail->Subject = 'Reporte de productos';
            $mail->Body    = 
                             ...
                             <tr style="border-collapse:collapse">
                              <td align="center" valign="top" style="Margin:0;width:700px">
                               <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-size:100%" role="presentation">
                                 ...
                                 <tr style="border-collapse:collapse">
                                  <td align="center" class="es-m-p30b amp-banner" style="Margin:0;font-size:0px"><a target="_blank" href="https://:v" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:"open sans", "helvetica neue", helvetica, arial, sans-serif;font-size:15px;text-decoration:underline;color:#000001"><img src="http://imgfz.com/i/7ijSLlz.png" alt="Confirmacion de cuenta" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic" width="374" sizes="(max-width:600px) 80vw, 373px" class="adapt-img" title="Confirmacion de cuenta"></a></td>
                                 </tr>
                               </table></td>
                             </tr>
                           </table></td>
                             ...
                             <tr style="border-collapse:collapse">
                              <td align="center" valign="top" style="Margin:0;width:540px">
                               <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                 <tr style="border-collapse:collapse">
                                  <td align="left" style="Margin:0;padding-bottom:10px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:15px;font-family:"open sans", "helvetica neue", helvetica, arial, sans-serif;line-height:30px;color:#000000">¡Hola '.$user.'!<span style="font-family:roboto, "helvetica neue", helvetica, arial, sans-serif"></span></p></td>
                                 </tr>
                                 <tr style="border-collapse:collapse">
                                  <td align="left" style="Margin:0;padding-bottom:10px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:15px;font-family:"open sans", "helvetica neue", helvetica, arial, sans-serif;line-height:30px;color:#000000">nos permitimos informales que la cantidad del producto(s) <h1>'.implode(",",$producs_pe).'</h1> esta(n) a
                                  punto de agotar sus existencias, Se le recomienda insertar nuevas existencias<br>
                                    Te invitamos a que inicies sesion en nuestra plataforma!&nbsp;<span style="font-family:roboto, "helvetica neue", helvetica, arial, sans-serif"></span></p><br>
    ...
    static public function ctrSendNotifyCuantityMP($user,$MP_Pe){
        $mail=new PHPMailer(true);
        try {
            //Server settings
            $mail->SMTPDebug = 0;                      // Enable verbose debug output
            ...
            // Content
            $mail->isHTML(true);                                  // Set email format to HTML
            $mail->Subject = 'Reporte de Materia Prima';
            $mail->Body    = 
            '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
            <html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" style="width:100%;height:100%;font-family:"open sans", "helvetica neue", helvetica, arial, sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;Margin:0">
             <head>
                             ...
                             <tr style="border-collapse:collapse">
                              <td align="center" valign="top" style="Margin:0;width:700px">
                               <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-size:100%" role="presentation">
                                 ...
                                 <tr style="border-collapse:collapse">
                                  <td align="center" class="es-m-p30b amp-banner" style="Margin:0;font-size:0px"><a target="_blank" href="https://:v" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:"open sans", "helvetica neue", helvetica, arial, sans-serif;font-size:15px;text-decoration:underline;color:#000001"><img src="http://imgfz.com/i/lOxkf1e.png" alt="Confirmacion de cuenta" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic" width="374" sizes="(max-width:600px) 80vw, 373px" class="adapt-img" title="Confirmacion de cuenta"></a></td>
                                 </tr>
                               </table></td>
                             </tr>
                           </table></td>
                             ...
                             <tr style="border-collapse:collapse">
                              <td align="center" valign="top" style="Margin:0;width:540px">
                               <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                 ...
                                 <tr style="border-collapse:collapse">
                                  <td align="left" style="Margin:0;padding-bottom:10px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:15px;font-family:"open sans", "helvetica neue", helvetica, arial, sans-serif;line-height:30px;color:#000000">nos permitimos informales que la cantidad de materia(s) <h1>'.implode(",",$MP_Pe).'</h1> esta(n) a
                                  punto de agotar sus existencias, Se le recomienda insertar nuevas existencias<br>
                                    Te invitamos a que inicies sesion en nuestra plataforma!&nbsp;<span style="font-family:roboto, "helvetica neue", helvetica, arial, sans-serif"></span></p><br>
                                      <a href="http://localhost/RPPSQUIMICOS/index.php?paginasUsuario=InicioSesion" class="btn btn-success">Ir a inicio de sesión<a>
                                    </td>
