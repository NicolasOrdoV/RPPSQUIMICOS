   ...
   <aside class="col-lg-8">
     <div class="row py-3">
       ...
       <form class="col-lg-6 py-5 needs-validation" id="form" method="POST" novalidate>
         <a href="?paginasPedidos=ConsultaPedidos&id=<?php echo $user["idEMPLEADO"] ?>" class="btn btn-danger rounded float-left" title="Volver"><i class="fas fa-angle-double-left"></i></a>
